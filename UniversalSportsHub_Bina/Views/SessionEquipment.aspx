<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SessionEquipment.aspx.cs" Inherits="UniversalSportsHub_Bina.Views.SessionEquipment" %>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Session Equipment Details</a>
                </div>
        ...
        <div class="content">
            ...
            <div class="col-lg-12">
                <h3>Session Equipment Details</h3>
                        <div class="card ">
                           
                            
                           
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT USHSESSION.SESSIONCODE, USHSESSION.STARTTIME, USHSESSION.PERIODINHOURS, USHSESSION.DATEOFSESSION, USHSESSION.ACTIVITYID, USHSESSION.ROOMID, USHSESSION.REFNO, EQUIPMENT.EQUIPMENTID, EQUIPMENT.EQUIPMENTNAME FROM USHSESSION, EQUIPMENT"></asp:SqlDataSource>
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="SESSIONCODE,EQUIPMENTID" DataSourceID="SqlDataSource1">
                                <Columns>
